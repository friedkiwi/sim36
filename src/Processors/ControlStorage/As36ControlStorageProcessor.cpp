...
void As36ControlStorageProcessor::buildFromUnitDefinitionTable()
{
    ...
    // system-personality byte differs.  This migrates the short-lived 8D
    // Advanced/36 identity: 8D is a 5364, whose SSP configuration limit is
    // zero local work stations; the real Advanced/36 table says 89.
